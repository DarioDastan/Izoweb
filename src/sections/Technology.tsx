        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-2">Thermal Insulation</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-2">Structural Integrity</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-2">Climate Optimized</h4>
